...
<style>
/*.demo {float: left; margin: auto; width: 23.5%;}*/
			...
			<div class="portlet-content">
				<div id="painel_chamado">				
					...
					<? if($dtP->Count() == 0){ ?>
						...
						<p class="boasvindas_nomeinferior">DEFENSORIA PÚBLICA</p>
						...
						<input type="hidden" id="timereload" name="timereload" value="20000">
					<? }else{ ?>						
							<div><p class="nome">SENHA</p><br>
