...
function carregaHistorico(idAssistencia,idAssistido){
	var comboassis = createXMLHTTP();
	...
	comboassis.onreadystatechange= function()
	{
		if(comboassis.readyState == 4){	
			...
			document.getElementById("btgerainfassis").innerHTML = '<img title="Gerar Hist. Assistido" src="imagens/bloco_notas.png" style="width:25px; cursor:pointer; position:relative; left:-0px; top:-2px; *top:-2px; _top:-2px; *left:-4px; _left:-4px; margin:3px 5px 0px 0px; display:block;" onclick="NewPage(\'doc/docinfassis.php?id='+idAssistido+'&ida='+idAssistencia+'\',\'InfoAllAssis\',\'900\',\'600\',\'yes\')" />';
		}
	}	

	comboassis.send("assis="+idAssistencia);	
}
