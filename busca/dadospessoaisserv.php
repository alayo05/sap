...
<form id="frm_dados_pessoais" name="frm_dados_pessoais" method="post" onclick="" onSubmit="return VerificaDPServ()">
	...
	<tr>
		...
		<td align="left">					
			<select id="tpusuario" name="tpusuario" onchange="alteratipoacesso(this)" style="font-size:12px; margin-left:10px;" disabled>				
				<?
...
<?	
	...
	if(isset($npage) AND $npage > 1){	
		$sql = $sql . " LIMIT ".intval($maxlimit-$recordPerPage).", ".$maxlimit;
		$pg = $npage;		
	}else{
