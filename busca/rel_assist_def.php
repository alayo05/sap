...
<? 
	...
	if(isset($dti) AND $dti !=""){
		if(isset($dtf) AND $dtf != ""){
			$sqlperiodo = " AND h.dataAtendimento BETWEEN '".$dti." 00:00:00' AND '".$dtf." 23:59:59' ";
		}else{
			$sqlperiodo = " AND h.dataAtendimento BETWEEN '".$dti." 00:00:00' AND DATE_FORMAT(NOW(),'%Y-%m-%d %H:%i:%s') ";
		}
	}else{
